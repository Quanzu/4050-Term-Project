...
<nav class="navbar navbar-default" data-spy="affix" data-offset-top="270">
  ...
  <div id="District" class="container">
    <h3>District 
    <button type = "button">Create District</button>
    </h3>
    
    <form method = "post" action = "createED">
		Name of District: <input type = "text" name = "dName" value = ""/><br>
		
		<input type = "submit" name = "submit" value = "submit">
		<input type = "hidden" name = "option" value = "createDistrict">
	</form>
